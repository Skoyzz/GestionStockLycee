...
{
    header("localistion : ../accueil_bienvenue-admin/bienvenue_admin.php");
}
else
{
}
...
"<tr>";
            ...
            echo "<td>".   "<a href='../modification/en_cours/modification_carnet.php?id=".$ligne['id']."'<button>Modifier le carnet</button></a>" . "<br>" ;
            echo "<tr+>"."<td>" .  "<a href='../supprimer/supprimer_carnet.php?id=".$ligne['id']."'<button>Supprimer le carnet</button></a>" . "</td>" . "</tr>";
        }
        ?>
    </tr>
    </tbody>
