...
<table border="1">
    ...
    <tr>
        ...
        while($ligne = $resultat->fetch()) {
            echo "<td>". $ligne['nomUtilisateur'].
                "</td>";
            echo "<td>". $ligne['prenomUtilisateur'].
                "</td>";
            echo "<td>". $ligne['numeroMachine'].
                "</td>";
            echo "<td>". $ligne['panneUtilisateur'].
                "</td>";
            echo "<td>". $ligne['reparationUtilisateur'].
                "</td>";
            echo "<td>". $ligne['commentaireUtilisateur'] .
                "</td>";

            echo "<td>".   "<a href='../modification/en_cours/modification_suivi.php?id=".$ligne['id']."'<button>Modifier le suivi</button></a>" . "<br>" ;
            echo "<tr+>"."<td>" .  "<a href='../supprimer/supprimer_suivi.php?id=".$ligne['id']."'<button>Supprimer le suivi</button></a>" . "</td>" . "</tr>";
