...
<div class="bodycentre">
    ...
    $reponse = $conn->query('SELECT * FROM carnet_utilisation WHERE id='.$_GET['id']);
    $donnees = $reponse->fetch();

    echo '<form action="../reussi/modification_reussi_carnet.php" method="post">
        ...
        <input type="text" name="dateUtilisation" placeholder="Nouvelle date de l\'utilisateur" value="' . $donnees['dateUtilisation'] . '"/>
        ...
        <input type="submit" value="Modifier le carnet"/>';
