...
<?php
    ...
    $reponse = $conn->query('SELECT * FROM compte_user WHERE id='.$_GET['id']);
    $donnees = $reponse->fetch();

    echo '<form action="../reussi/modification_reussi_utilisateur.php" method="post">
        <input type="text" name="nomIdentifiant" placeholder="Nouveaux identifiant" value="' . $donnees['nomIdentifiant'] . '"/>
